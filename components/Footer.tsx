        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 py-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a href="#" aria-label="YouTube" className="text-gray-500 hover:text-[#BF4E14] transition-colors">
                <Youtube size={18} />
              </a>
              <a href="#" aria-label="LinkedIn" className="text-gray-500 hover:text-[#BF4E14] transition-colors">
                <Linkedin size={18} />
              </a>
              <a href="#" aria-label="Facebook" className="text-gray-500 hover:text-[#BF4E14] transition-colors">
                <Facebook size={18} />
              </a>
              <a href="#" aria-label="Instagram" className="text-gray-500 hover:text-[#BF4E14] transition-colors">
                <Instagram size={18} />
              </a>
            </div>
          </div>
